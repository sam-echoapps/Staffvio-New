...
module.exports = {
  entry: path.resolve(configPaths.src.common, 'index.ts'),
  output: {
      ...
      },
      {
        ...
        options: {
          getCustomTransformers: program => ({
            before: [
              metadataTransformer(program),
              decoratorTransformer(program)
            ]
          })
        }
      },
  ...
  plugins: [
    ...
    new WebpackRequireFixupPlugin({
      ojModuleResources: {
        ...
        root: path.resolve(configPaths.staging.web, configPaths.src.javascript),
      ...
      baseResourceUrl: path.join(configPaths.staging.web, configPaths.src.javascript, `libs/oj/v${ojetUtils.getJETVersion()}`),
    }),
  ],
};
