  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      if (util.isJETPack({ componentJson })) {
        ...
        if (util.hasProperty(componentsCache[packName].componentJson, 'dependencies')) {
          Object.keys(componentsCache[packName].componentJson.dependencies).forEach((packMemberName) => { // eslint-disable-line max-len
