...
@mixin oj-fwk-icon-cbsingle-hover-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
...
@mixin oj-fwk-icon-checkbox-ena-unselected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-100px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-pressed-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-120px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-pressed-unselected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-140px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-tristate-partial-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-160px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-checkbox-tristate-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-180px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-checkmark-blue-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-220px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-checkmark-white-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-240px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-dis-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-292px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-ena-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-332px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-ena-unselected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-352px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-pressed-selected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-372px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-radio-pressed-unselected-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-392px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-10-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-456px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-20-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-500px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-30-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-544px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-40-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-588px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-50-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-632px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-60-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-676px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-70-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-720px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-80-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-764px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-90-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-808px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}

// Include this mixin in component SCSS if the image needs to be scaled.
@mixin oj-fwk-icon-spinner-static-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-852px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
...
@mixin oj-fwk-icon-status-confirmation-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-888px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-error-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-908px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-status-warning-scale($scaleFactor: 1) {
  background-size: calc(968px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-948px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(16px * #{$scaleFactor});
  height: calc(16px * #{$scaleFactor});
}
...
@if $includeIconClasses != false {
  @include module-include-once("alta.sprite") {
    ...
    .oj-fwk-icon-checkmark-blue {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-checkmark-blue-scale;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-checkmark-blue:before {
      content: oj-image-url('checkmark_blue.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-fwk-icon-checkmark-white {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-checkmark-white-scale;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-checkmark-white:before {
      content: oj-image-url('checkmark_white.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-fwk-icon-spinner-static {
      background-image: oj-image-url('sprites/sprite.svg');
      @include oj-fwk-icon-spinner-static-scale;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-spinner-static:before {
      content: oj-image-url('spinner_static.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-status-confirmation:before {
      content: oj-image-url('status_confirmation.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-status-error:before {
      content: oj-image-url('status_error.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-status-info:before {
      content: oj-image-url('status_info.svg');
      width: 100%;
      height: 100%;
    }
    ...
    .oj-hicontrast .oj-fwk-icon-status-warning:before {
      content: oj-image-url('status_warning.svg');
      width: 100%;
      height: 100%;
    }
