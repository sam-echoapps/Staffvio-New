  ...
  @include module-include-once("common.tagstypography") {
    ...
    @include oj-tag-selectors(
      ...
      .oj-typography-title-1 {
        font-size: $header1FontSize !important;
        font-weight: $header1FontWeight !important;
      }

      .oj-typography-heading-xl,
      .oj-typography-title-2 {
          font-size: $header2FontSize !important;
          font-weight: $header2FontWeight !important;
      }

      .oj-typography-heading-lg,
      .oj-typography-title-3 {
          font-size: $header3FontSize !important;
          font-weight: $header3FontWeight !important;
      }

      .oj-typography-heading-md,
      .oj-typography-title-4 {
          font-size: $header4FontSize !important;
          font-weight: $header4FontWeight !important;
      }

      .oj-typography-heading-sm,
      .oj-typography-title-5 {
          font-size: $header5FontSize !important;
          font-weight: $header5FontWeight !important;
      }

      .oj-typography-heading-xs,
      .oj-typography-title-6 {
          font-size: $header6FontSize !important;
          font-weight: $header6FontWeight !important;
      }
