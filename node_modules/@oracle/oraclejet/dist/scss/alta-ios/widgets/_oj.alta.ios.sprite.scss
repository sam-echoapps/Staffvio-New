...
@mixin oj-fwk-icon-cbsingle-dis-selected-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
...
@mixin oj-fwk-icon-spinner-00-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-390px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
...
@mixin oj-fwk-icon-spinner-10-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-434px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-20-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-478px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-30-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-522px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-50-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-610px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-60-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-654px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-70-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-698px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-80-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-742px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
...
@mixin oj-fwk-icon-spinner-90-scale($scaleFactor: 1) {
  background-size: calc(830px * #{$scaleFactor}) calc(44px * #{$scaleFactor});
  background-position: calc((-786px - 2px) * #{$scaleFactor}) calc((0px - 2px) * #{$scaleFactor});
  width: calc(40px * #{$scaleFactor});
  height: calc(40px * #{$scaleFactor});
}
