...
@if $includeColorSpectrumClasses != false {
  $includeSliderClasses: true !global;
}

// import dependencies
@import "../../common/helpers/oj.common.helpers"; 
@import "oj.alta.android.formcontrol.slider";

// ----- end dependencies ---------


// import classes defined in the common directory
@import "../../common/widgets/oj.common.formcontrol.colorspectrum";

@if $includeColorSpectrumClasses != false  {
   @include module-include-once("alta.android.colorspectrum") {
  }
}