...
// for example menu-select-many/themes/redwood/oj-menu-select-many.scss
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
@include module-include-once("common.menuselectmany") {
  ...
  .oj-menucheckbox-icon {
    @extend .oj-component-icon !optional;
  ...
  .oj-menucheckbox-icon.oj-selected {
    @extend .oj-fwk-icon-checkmark !optional;
  }
