...
@import "../../../button/themes/redwood/_oj-button-scoped.cssvars.scss";

@include module-include-once("redwood.variables.buttonset.scoped") {
  ...
  oj-buttonset-many {
    ...
    --oj-button-outlined-chrome-text-color:        var(--oj-core-text-color-secondary);
    --oj-button-outlined-chrome-bg-color-disabled: var(--oj-button-solid-chrome-bg-color-disabled);
    --oj-button-outlined-chrome-bg-color-active:   rgba(var(--oj-palette-neutral-rgb-190),.16);
  }
}