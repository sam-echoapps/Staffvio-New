...
@import "../../../buttonset/themes/stable/_oj-buttonset.cssvars.scss";
@import "../../../tooltip/themes/stable/_oj-tooltip.cssvars.scss";
@import "../../../tags/themes/stable/_oj-tags.cssvars.scss";

@include module-include-once("stable.variables.dvtbase") {
:root {
    ...
    --oj-private-dvt-gridline-color:          rgba(var(--oj-palette-neutral-rgb-190), 0.1);
  }
}