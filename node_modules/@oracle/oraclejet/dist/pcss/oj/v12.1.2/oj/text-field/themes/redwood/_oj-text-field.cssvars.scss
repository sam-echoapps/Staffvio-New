...
@import "../../../palette/themes/redwood/_oj-palette.cssvars.scss";
@import "../../../form-layout/themes/redwood/_oj-form-layout.cssvars.scss";
@import "../../../form-control/themes/redwood/_oj-form-control.cssvars.scss";
// scoped cssvars override
@import "../../../palette/themes/redwood/_oj-palette-scoped.cssvars.scss";
@import "../../../core/themes/redwood/_oj-core-scoped.cssvars.scss";
@import "../../../core/themes/redwood/_oj-core-ignore.scoped.cssvars.scss";
@import "oj-text-field-ignore.scoped.cssvars.scss";

  @include module-include-once("redwood.variables.textfield") {
:root { 
    ...
    // oj-form-control-input variables apply to
    // input style form controls, like input text, password, etc
    // --oj-text-field-height should match the button height
    ...
    // todo: ideally this pointed  at --oj-core-border-color-selected but it's not the same color
