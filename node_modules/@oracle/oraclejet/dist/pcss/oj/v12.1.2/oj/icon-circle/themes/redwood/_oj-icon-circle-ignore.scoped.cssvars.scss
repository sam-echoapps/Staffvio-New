...
@import "../../../avatar/themes/redwood/_oj-avatar-scoped.cssvars.scss";


@include module-include-once("redwood.variables.icon.color.size") {
  .oj-icon-circle-xxs .oj-icon-circle-inner,
  .oj-icon-xxs .oj-icon-circle-inner {
    @extend .oj-avatar-xxs;
    font-size: 0.75rem;
  }
