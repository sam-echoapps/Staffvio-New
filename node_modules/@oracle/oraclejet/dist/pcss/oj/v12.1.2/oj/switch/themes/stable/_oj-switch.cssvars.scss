...
@import "../../../animation/themes/stable/oj-animation.scss";
  ...
  @include module-include-once("stable.variables.switch") {
...
:root {
  ...
  --oj-switch-track-border-radius:                  1.25rem;
  ...
  --oj-switch-thumb-height:                         1rem;
  --oj-switch-thumb-width:                          1rem;
  --oj-switch-thumb-border-radius:                  50%;
