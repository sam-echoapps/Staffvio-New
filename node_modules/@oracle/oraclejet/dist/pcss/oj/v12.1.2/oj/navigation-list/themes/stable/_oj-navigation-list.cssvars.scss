...
@import "../../../toolbar/themes/stable/_oj-toolbar.cssvars.scss";
@import "../../../tree-view/themes/stable/_oj-tree-view.cssvars.scss";
@import "../../../menu/themes/stable/_oj-menu.cssvars.scss";

  @include module-include-once("stable.variables.navigationlist") {
...
:root {
  ...
  // $privateAnimationDurationMedium hardcoded
  --oj-private-navigation-list-global-slider-expand-animation-default: '{"effect":"slideIn","direction":"start","duration":".4s"}';
  --oj-private-navigation-list-global-slider-collapse-animation-default: '{"effect":"slideIn","direction":"end","duration":".4s"}';
