...
// for example color-palette/themes/redwood/oj-color-palette.scss
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
@include module-include-once("common.formcontrol.colorpalette") {
  ...
  .oj-colorpalette-swatch-none-icon {
    ...
    display: inline-block;
    background-image: url("#{$imageDir}none.svg");
  ...
  // To remove the selection borders (that causes jumping on selection)
