    ...
    class ViewClientModel {
        constructor(context) {
                ...
                function getClientProfile(){
                    ...
                    $.ajax({                   
                        ...
                        success: function (data) {
                            ...
                            self.countryCode(data[0][0][14])
                            self.altCountryCode(data[0][0][15])

                            for (var i = 0; i < data[1].length; i++) {
                                self.ClientGroup.push({'value' : data[1][i][1], 'label' : data[1][i][1]});
                            }
                            for (var i = 0; i < data[2].length; i++) {
                                self.ClientType.push({'value' : data[2][i][0], 'label' : data[2][i][1]});
                            }
                    }
                ...
                self.clientBasicUpdate = function (event,data) {
                    if(self.selectedClientType() == 'Care Home'){
                        self.selectedClientType(Number(1))
                    }else if(self.selectedClientType() == 'Community Centre'){
                        self.selectedClientType(Number(2))
                    }else if(self.selectedClientType() == 'Domiciliary Care'){
                        self.selectedClientType(Number(3))
                    }else if(self.selectedClientType() == 'External Platform'){
                        self.selectedClientType(Number(4))
                    }else if(self.selectedClientType() == 'Learning Disability Home'){
                        self.selectedClientType(Number(5))
                    }else if(self.selectedClientType() == 'NHS Hospital'){
                        self.selectedClientType(Number(6))
                    }else if(self.selectedClientType() == 'Nursing Home'){
                        self.selectedClientType(Number(7))
                    }else if(self.selectedClientType() == 'Private Hospital'){
                        self.selectedClientType(Number(8))
                    }else if(self.selectedClientType() == 'Residential Home'){
                        self.selectedClientType(Number(9))
                    }else if(self.selectedClientType() == 'Supported Living'){
                        self.selectedClientType(Number(10))
                    }
