...
define([], function () {
    ...
    var avatarColorPalette = ["#A12D17", "#4F8115", "#166443", "#18156F", "#475490", "#891639", "#154BC7", "#176113"];
    ...
    var setPageBusyContext = function() {
      ...
      //console.log('[FIF App] Setting up app level busy context:', options.description);
    ...
    var resolvePageBusyContext = function() {
      if (pageBusyResolve) {
        pageBusyResolve();
        //console.log('[FIF App] Resolving app level busy context');
