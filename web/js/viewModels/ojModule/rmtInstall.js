            ...
            if (self.onepDepUrl().length > 0) {
             ...
             $.ajax({
               ...
               success: function (data) {
                 ...
                 else if (self.DepType() == 'BigData Targets'){
                    self.ggDepDBClientVerLabel('Installed Goldengate OS Platform');
                    self.ggDepDBVerLabel('JDK Version');
                    self.ggDepDBHomeLabel('Java Home Path');
                }
                    ...
                    self.fileNames(
                        Array.prototype.map.call(files, function (file) {
                            ...
                            $.ajax({
                                ...
                                success: (data) => {
                                    //console.log("Success!");
                                    self.diagTitle('Upload Software for ' + self.DepType())
